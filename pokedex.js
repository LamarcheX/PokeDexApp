...
const pokemonContenedor = document.getElementById("pokemon-container");
...
searchBar.addEventListener("input", (e) => {
  ...
  const pokemonFiltrado = listaPokemones.filter((pokemon) =>
    pokemon.name.toLowerCase().includes(searchValue)
  );
  // Mostramos los Pokémon filtrados.
  displayAllPokemon(pokemonFiltrado);
});
...
const fetchAllPokemon = async () => {
  ...
  displayAllPokemon(listaPokemones);
};
